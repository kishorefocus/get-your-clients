...
import {
  Globe2, CheckCircle2, Shield, Eye, EyeOff
} from "lucide-react";
...
export default function SignupPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setState("success");
      toast.success(res.is_new_user ? "Workspace created! Welcome to GetYourClients!" : "Welcome back!");
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-12 bg-background">
      ...
      <main className="col-span-1 flex flex-col justify-between p-6 sm:p-10 lg:col-span-5 bg-card border-r border-border relative overflow-y-auto min-h-screen">
        ...
        {/* Center content: Signup Form Card */}
              ...
              {state === "success" ? (
                ...
                >
                  <motion.div variants={staggerChild}>
                    <h1 className="font-display text-2xl font-bold tracking-tight text-foreground">Start your free trial</h1>
