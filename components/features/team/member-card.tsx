...
export function MemberCard({ member, index }: Props) {
  ...
  return (
    <div className="group flex flex-col rounded-xl border border-border bg-card p-5 shadow-subtle hover:shadow-card transition-shadow animate-fade-up">
      {/* Header */}
          ...
          <div className="relative">
            ...
            <span
              className={cn(
                ...
                member.online ? "bg-success" : "bg-muted-foreground/30"
              )}
            />
          </div>
          <div>
